...
const {
  ...
  var cardGame = function(playerOneCards, playerTwoCards){
    ...
    let Castillo1 = 100;
    let Castillo2 = 100;
    while(Castillo1 > 0 && Castillo2 > 0 && playerOneCards.array.length >= 2 && playerTwoCards.array.length >= 2){
      let CFP1 = playerOneCards.dequeue();
      let CSP1 = playerOneCards.dequeue(); 
      let CFP2 = playerTwoCards.dequeue();
      let CSP2 = playerTwoCards.dequeue();
      let R1 = CSP2.defense - CFP1.attack;
      let R2 = CSP1.defense - CFP2.attack;
       if( R1 < 0){
         Castillo2 = Castillo2 + R1;
       }
       if(R2 < 0){
